;;; rk-neotree.el --- Configuration for neotree.  -*- lexical-binding: t; -*-
...
(use-package neotree
  ...
  :preface
  (progn
    (use-package rk-neotree-cmds
      :commands (rk-neotree-expand-or-open
                 rk-neotree-collapse
                 rk-neotree-collapse-or-up
                 rk-neotree-find-project-root)))
  ...
  (progn
    (spacemacs-keys-set-leader-keys
      "ft" #'neotree-toggle
      "pt" #'rk-neotree-find-project-root)

    (evil-transient-state-define rk-neotree
...
"
        ...
        ("gr" neotree-refresh)
        ("h" rk-neotree-collapse-or-up)
        ("H" neotree-select-previous-sibling-node)
        ("j" next-line)
        ("J" neotree-select-down-node)
        ("k" previous-line)
        ("K" neotree-select-up-node)
        ("l" rk-neotree-expand-or-open)
