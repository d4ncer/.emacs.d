...
(use-package evil-collection
  ...
  :after evil
  :custom
  (evil-collection-mode-list `(eat ebib comint cider dired racer git-timemachine ibuffer help info docker magit forge (pdf pdf-view) ediff deadgrep profiler custom))
  :config
