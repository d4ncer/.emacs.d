...
(use-package codeium
  ...
  :preface
  (defun rk-codeium/document/text ()
    (buffer-substring-no-properties (max (- (point) 3000) (point-min)) (min (+ (point) 1000) (point-max))))
  ;; if you change the text, you should also change the cursor_offset
  ;; warning: this is measured by UTF-8 encoded bytes
  (defun rk-codeium/document/cursor_offset ()
  ...
  (codeium/document/text 'rk-codeium/document/text)
  (codeium/document/cursor_offset 'rk-codeium/document/cursor_offset)
  :config
  ;; (setq use-dialog-box nil) ;; do not use popup boxes

  ;; TODO: modeline is not working
