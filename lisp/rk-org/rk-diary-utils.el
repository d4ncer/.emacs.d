;;; rk-diary-utils.el --- Functions used by the diary.

;; Copyright (C) 2016 Raghuvir Kasturi
...
(defun calendar-mondayised (target-day target-month)
  "Given anniversary with TARGET-DAY and TARGET-MONTH, return non-nil if:
...
(provide 'rk-diary-utils)

;;; rk-diary-utils.el ends here
